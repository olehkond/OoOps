...
if {$TOOL_NAME == "ICC"} {
   alias rst0  "close_mw_cel;open_mw_cel ${design_name}_init;       source ${SCRIPTS_DIR}/floorplan.tcl -echo"
   alias rst1  "close_mw_cel;open_mw_cel ${design_name}_prepns;     source ${SCRIPTS_DIR}/power.tcl -echo"
   alias rst2  "close_mw_cel;open_mw_cel ${design_name}_preplaceopt;source ${SCRIPTS_DIR}/placeopt.tcl -echo"
   alias rst3  "close_mw_cel;open_mw_cel ${design_name}_preclock;   source ${SCRIPTS_DIR}/clocks.tcl -echo"
   alias rst4  "close_mw_cel;open_mw_cel ${design_name}_preroute;   source ${SCRIPTS_DIR}/route.tcl -echo"
   alias rst5  "close_mw_cel;open_mw_cel ${design_name}_prefinish;  source ${SCRIPTS_DIR}/finishing.tcl -echo"
}

# source common tcl functions
# ==========================================================================
source ${SCRIPTS_DIR}/create_metal_blockage.tcl
source ${SCRIPTS_DIR}/create_via_blockage.tcl
