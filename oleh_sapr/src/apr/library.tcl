...
# Set symbol library, link path, and link libs
set_app_var link_path [concat "*" $TARGET_LIBS]
set_app_var link_library [concat * $TARGET_LIBS $SYNOPSYS_SYNTHETIC_LIB]

if {[llength $ADDITIONAL_TARGET_LIBS] > 0} {
   set_app_var target_library [concat $target_library $ADDITIONAL_TARGET_LIBS]
   set_app_var link_path [concat $link_path $ADDITIONAL_TARGET_LIBS]
   set_app_var link_library [concat $link_library $ADDITIONAL_TARGET_LIBS"
}
