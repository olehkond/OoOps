...
# DVE full session
# Saved on Thu Jun 2 15:24:43 2022
# Designs open: 1
#   V1: OoO_top.vpd
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{6 31} {1478 758}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 454} {height 515} {dock_state left} {dock_on_new_line true} {child_hier_colhier 352} {child_hier_coltype 101} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 438} {height 515} {dock_state left} {dock_on_new_line true} {child_data_colvariable 222} {child_data_colvalue 87} {child_data_coltype 226} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1472} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{59 60} {1587 837}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 443} {child_wave_right 1080} {child_wave_colname 220} {child_wave_colvalue 221} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sg_addsignal -group "$_session_group_12" { OoO_top_tb.dut.instr_fetch_i OoO_top_tb.dut.program_counter_o OoO_top_tb.dut.clk_i OoO_top_tb.dut.reset_i }

set _session_group_13 Group2
gui_sg_create "$_session_group_13"
set Group2 "$_session_group_13"

gui_sg_addsignal -group "$_session_group_13" { EXP:x1 EXP:x2 EXP:x3 EXP:x4 EXP:x5 EXP:x6 EXP:x7 EXP:x8 EXP:x9 EXP:x10 EXP:x11 EXP:x12 EXP:x13 EXP:x14 EXP:x15 EXP:x16 EXP:x17 EXP:x18 EXP:x19 EXP:x20 EXP:x21 EXP:x22 EXP:x23 EXP:x24 EXP:x25 EXP:x26 EXP:x27 EXP:x28 EXP:x30 EXP:x29 EXP:x31 }
gui_set_radix -radix {decimal} -signals {EXP:x1}
gui_set_radix -radix {unsigned} -signals {EXP:x1}
gui_set_radix -radix {decimal} -signals {EXP:x2}
gui_set_radix -radix {unsigned} -signals {EXP:x2}
gui_set_radix -radix {decimal} -signals {EXP:x3}
gui_set_radix -radix {unsigned} -signals {EXP:x3}
gui_set_radix -radix {decimal} -signals {EXP:x4}
gui_set_radix -radix {unsigned} -signals {EXP:x4}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 479737
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_add_group -id ${Wave.1} -after {New Group} {Group2}
gui_list_select -id ${Wave.1} {EXP:x1 EXP:x2 EXP:x3 EXP:x4 }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group2  -item EXP:x4 -position below

gui_marker_move -id ${Wave.1} {C1} 48446
